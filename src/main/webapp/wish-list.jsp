		...
		<div class="container-xxl py-5">
			<div class="container">
				...
				<div class="text-center wow fadeInUp" data-wow-delay="0.1s">
					<h6 class="section-title text-center text-primary text-uppercase">Your wish-list is empty</h6>
					<h1 class="mb-5">
						Explore Our <span class="text-primary text-uppercase" href="room-list.jsp">Rooms</span>
					</h1>
				</div>
				</c:if>
						...
						<div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
							<div class="room-item shadow rounded overflow-hidden">
								<div class="position-relative">
									<img class="img-fluid" src="${room.value.image1Url}" alt="image-room">
									<small
								...
								<div class="p-4 mt-2">
									...
									<div class="d-flex mb-3">
										<small class="border-end me-3 pe-3"><i
											class="fa fa-bed text-primary me-2"></i>${room.value.countBed} Bed</small> <small
											class="border-end me-3 pe-3"><i
											class="fa fa-bath text-primary me-2"></i>${room.value.countBath} Bath</small> <small><i
											class="fa fa-wifi text-primary me-2"></i>Wifi</small>
									</div>
									<p class="text-body mb-3">${room.value.description}</p>
									<div class="d-flex justify-content-between">
										<a class="btn btn-sm btn-primary rounded py-2 px-4"
											href="room?roomId=${room.value.id}">View Detail</a>
										<a class="btn btn-sm btn-primary rounded py-2 px-4" href="wish-list?command=REMOVE&roomId=${room.key}">Remove</a>
